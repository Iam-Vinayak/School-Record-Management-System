...
<div class="bulk-table-container">
        ...
        <form method="post" action="bulk_delete_staff.php" id="bulk-delete-form">
            ...
            <button type="submit" onclick='return deleteRecord()' id="delete_all_records" class='delete-records' name='delete_multiple_staff_btn'>
                ...
                <table class="bulk-table-details" width="150%">
                    <thead>
                        <tr>
                        <th width="8%">Select all <br> <div class="delete_checkbox"><input type='checkbox' id='checkAll' name='delete_multiple_staff_id[]' value='';></th></div>
            ...
            ?>
                <tr> 
                    <td>
                    <div class="delete_checkbox"><input type='checkbox' class='checkbox_item' name='delete_multiple_staff_id[]' value='<?=  $result['stf_id'];?>'/></div>
                    </td>
                    <td><?= $result['stf_id']; ?></td>
...
// $(document).ready(function () {
        ...
        function loadAllData() {
            $.ajax({
                url: "./config/bulk_delete_search_staff.php",
                method: "POST",
                data: { input: '' },
