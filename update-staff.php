        ...
        if (isset($_GET['stf_id']))
         {
            ...
            $query = "SELECT * FROM staff where stf_id = '$stf_id'";
        ...
        ?>
                ...
                <div class="info-box">
                    ...
                    <div class="info-box">
                        ...
                        <input type="number" value="<?php echo $result['stf_id'];?>" name="stf_id" required readonly>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update'])) 
{
    ...
    $update_staff_query = "UPDATE staff set full_name='$full_name', email='$email', phone_no='$phne_number', dob='$birth_date', gender='$gender', address='$address', qualification='$qualification' where stf_id='$stf_id'";

    $staff_data = mysqli_query($conn, $update_staff_query) or die(mysqli_error($conn));
    if ($staff_data) {
